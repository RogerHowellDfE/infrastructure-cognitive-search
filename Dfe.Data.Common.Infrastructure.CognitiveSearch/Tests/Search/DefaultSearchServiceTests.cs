...
public class DefaultSearchServiceTests
{
    private readonly Mock<ISearchClientProvider> _searchClientProviderMock = new();
    ...
    public async Task SearchAsync_ReturnsExpected()
    {
        ...
        SearchOptions searchOptions = SearchOptionsTestDouble.SearchOptionsWithSearchField(searchKeyword);
        ...
        var searchService = new DefaultSearchService(_searchClientProviderMock.Object);
    ...
    public async Task SearchAsync_NullArgument_ThrowsArgumentNullException(string searchKeyword, string searchIndex)
    {
        ...
        SearchOptions searchOptions = SearchOptionsTestDouble.SearchOptionsBasic();
        var searchResults =
